...
public class TakedaSamuraiArmorMaterial implements ArmorMaterial {

    private static final int[] BASE_DURABILITY = new int[] {13, 15, 16, 11};
    private static final int[] PROTECTION_VALUES = new int[] {2, 5, 6, 3};
    public static final TakedaSamuraiArmorMaterial INSTANCE = new TakedaSamuraiArmorMaterial();
